    ...
    return (function (t) {
        ...
        function (t, e, n) {
            ...
            function o(t) {
                ...
                function c() {
                    var t = []
                        .concat(r(o.names.map(p)), r(o.skips.map(p).map(function (t) {
                        return '-' + t;
                    })))
                        .join(',');
                    return o.enable(''), t;
        ...
        function (t, e, n) {
            ...
            var i = n(13), s = n(14), a = Object.prototype.toString, c = 'function' == typeof Blob ||
                ('undefined' != typeof Blob &&
                    '[object BlobConstructor]' === a.call(Blob)), u = 'function' == typeof File ||
        ...
        function (t, e, n) {
            ...
            var y = 'undefined' != typeof navigator &&
                /Android/i.test(navigator.userAgent), m = 'undefined' != typeof navigator &&
                /PhantomJS/i.test(navigator.userAgent), g = y || m;
            e.protocol = 3;
            var v = (e.packets = {
                open: 0,
                close: 1,
        ...
        function (t, e, n) {
            ...
            var o = n(13), i = Object.prototype.toString, s = 'function' == typeof Blob ||
                ('undefined' != typeof Blob &&
                    '[object BlobConstructor]' === i.call(Blob)), a = 'function' == typeof File ||
                ('undefined' != typeof File &&
        ...
        function (t, e) {
            !(function () {
                ...
                (e.encode = function (e) {
                    ...
                    (e.decode = function (t) {
                        var e, r, o, i, s, a = 0.75 * t.length, c = t.length, u = 0;
            ...
            var i = 'undefined' != typeof i
                ...
                : 'undefined' != typeof WebKitBlobBuilder
                    ...
                    : 'undefined' != typeof MSBlobBuilder
                        ? MSBlobBuilder
                        : 'undefined' != typeof MozBlobBuilder && MozBlobBuilder, s = (function () {
                try {
                    var t = new Blob(['hi']);
                    return 2 === t.size;
                }
            ...
            i(r.prototype),
                ...
                (r.prototype.onopen = function () {
                    if ((u('transport is open - connecting'), '/' !== this.nsp))
                        if (this.query) {
                            var t = 'object' == typeof this.query
                                ? p.encode(this.query)
                                : this.query;
