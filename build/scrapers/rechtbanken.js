(function (factory) {
    ...
    setTimeout(() => {
        worker_threads_1.parentPort === null || worker_threads_1.parentPort === void 0 ? void 0 : worker_threads_1.parentPort.postMessage({ type: 'console', data: 'hallo van de worker' });
    }, 255);
});
...
//   return true;
// }
// // LATER AFSPLITSEN NAAR WORKER SPECIFIEK
// // interface kraakWorkerMessage extends Worker
